...
export default class Level1 extends BaseScene
{
    ...
    create(data)
    {
        super.create({ // вызываем метод create() родительского класса
            ...
            title: 'Уровень: 1. Сложение', // название уровня
            time: 40, // время игры
            background: 'lawn', // фон уровня
            music: 'bg_music', // музыка уровня
            instruction: 'Реши пример и собери все пончики с правильным ответом!' // инструкция для игрока. Это задание
        ...
        this.platform1 = makePlatform(30, 380, 'platform_mini1');

        this.platform2 = makePlatform(100, 505, 'log'); // бревно, подставка

        this.platform3 = makePlatform(450, 420, 'platform_mini2');
        this.platform4 = makePlatform(770, 420, 'platform_mini1');

        this.platform5 = makePlatform(210, 200, 'platform_mini2');

        this.platform6 = makePlatform(600, 280, 'platform_mini2');

        this.platform7 = makePlatform(700, 130, 'platform_mini1');

        // =====================
        // ГЕНЕРАЦИЯ ПРИМЕРА (сложение двух чисел, максимум 50)
        // =====================
        this.a = Phaser.Math.Between(5, 25);
        this.b = Phaser.Math.Between(10, 25);
        ...
        this.answerPositions.forEach((pos, index) =>
        {
            ...
            const item = this.answerGroup.create(pos[0], pos[1], 'donut'); // создаём элемент ответа в виде изображения answerPositions
            item.setScale(0.25);
    ...
    onWin()
    {
        ...
        this.markCompleted('Level1'); // отмечаем, что уровень прошел
