...
export default class Level2 extends BaseScene
{
    ...
    {
        super.create({
            title: 'Уровень: 2. Сложение',
            time: 40,
            background: 'lawn',
            instruction: 'Реши пример и собери все ягоды с правильным ответом!'
        });
        ...
        // =====================
        // ГЕНЕРАЦИЯ ПРИМЕРА (сложение двухзначных чисел, МАКСИМАЛЬНАЯ СУММА - 75)
        // =====================
        this.a = Phaser.Math.Between(10, 25);
        this.b = Phaser.Math.Between(25, 50);
        ...
        this.answerPositions.forEach((pos, index) =>
        {
            ...
            const item = this.answerGroup.create(pos[0], pos[1], 'berry')
                .setScale(0.25);
    ...
    {
        if (this.gameEnded) return; // игра закончилась, защита от 2х нажатий
    ...
    onWin()
    {
        ...
        this.markCompleted('Level2'); // отмечаем, что уровень прошел
